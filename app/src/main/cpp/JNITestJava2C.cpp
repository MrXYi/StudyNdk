...
Java_com_xiao_studyndk_nativeInterface_JNITest_init(JNIEnv *env, jclass type, jstring config_) {
...
JNIEXPORT void JNICALL
Java_com_xiao_studyndk_nativeInterface_JNITest_registerListener(JNIEnv *env, jclass type,
                                                                jobject listener) {
    // TODO
